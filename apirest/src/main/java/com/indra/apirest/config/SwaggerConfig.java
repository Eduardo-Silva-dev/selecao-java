...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.indra.apirest.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
		 "API de Controle de Combustivel",
		 "Esta API é utilizada para o Processo seletivo da Indra",
		 "Versão 1.0",
		 "",
		 new Contact("Eduardo Pereira", "https://github.com/Eduardo-Silva-Dev", "ads.eduardo.silva@gmail.com"),
